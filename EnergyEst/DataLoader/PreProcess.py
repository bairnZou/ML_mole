...
class QM9Data:
    def __init__(self, data_id, atoms, distance, u0):
        self.id = data_id
        self.atoms = atoms
...
class PreProcesser:
    def __init__(self, training_proportion, shuffle_seed):
    ...
    def load_data(self, file_path):
        ...
        for i in range(0, self.total_data):
            qm9data = QM9Data(int(id_list[i][4:10]), atoms_list[i], distance_list[i], u0_list[i])
